...
void fit(perceptron * p, float ** x, float * y, int dim, int size){
    ...
    //Armazena o valor passado mais 1 espa√ßo para o limiar
    ...
    //Dimens√£o recebe dim + 1 por conta do valor do limiar
    ...
    //repita at√© que err seja inexistente
    for ( j = 0; j < p->size; j ++){
		do {
	        err = 0; //erro come√ßa com o valor nulo
	        u = 0;
			...
			//Aplica a funÁ„o de limiar de ativaÁ„o
            yi = g(u);
